            ...
            <div className="w-full max-w-md relative z-10">
                ...
                >
                    <div className="flex flex-col items-center mb-8">
                        <div className="mb-4" style={{ width: 48, height: 48, background: 'linear-gradient(135deg, #6366f1, #8b5cf6)', borderRadius: 14, display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 0 20px rgba(99,102,241,0.4)' }}>
                            <ShieldAlert style={{ width: 24, height: 24, color: 'white' }} />
                        </div>
                        <h2 className="text-3xl font-black text-white tracking-tight">Welcome Back</h2>
                        <p className="text-sm text-slate-400 mt-2">Sign in to DisasterAI to continue</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div>
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="block w-full pl-11 pr-4 py-3.5 bg-slate-900/50 border border-slate-700/50 rounded-xl text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500/50 transition-all font-medium"
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full py-3.5 mt-2 px-4 rounded-xl text-white font-bold flex items-center justify-center gap-2 transition-all hover:opacity-90 active:scale-[0.98]"
                            style={{ 
